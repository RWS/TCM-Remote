...
{
    /// <summary>
    /// Singleton proxy for single instance of <see cref="TridionCmdlet"/> class that provides logging functionality.
    /// </summary>
    /// <seealso cref="ILogger" />
    public sealed class TridionCmdletLogger : ILogger
    {
        /// <summary>
        /// The static instance of the <see cref="TridionCmdletLogger"/> class.
        /// </summary>
        private static readonly TridionCmdletLogger _instance = new TridionCmdletLogger();

        /// <summary>
        /// The instance of the <see cref="TridionCmdlet"/> class.
        /// </summary>
        private static TridionCmdlet _cmdlet;
        ...
        /// <summary>
        /// Initializes the the instance of the <see cref="TridionCmdletLogger"/> with instance of <see cref="TridionCmdlet"/> class.
        /// </summary>
        /// <param name="cmdlet">The instance of the <see cref="TridionCmdlet"/> class.</param>
        public static void Initialize(TridionCmdlet cmdlet)
        {
            _cmdlet = cmdlet;
        }
